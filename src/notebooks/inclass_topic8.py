...
predDF_final.write.format('jdbc').options(
      url='jdbc:mysql://gr5069-main.ccqalx6jsr2n.us-east-1.rds.amazonaws.com/gr5069_main',
      driver='com.mysql.jdbc.Driver',
      dbtable='ne_gr5069_airbnb_rentals_predictions',
      user='admin_teams',
      password='columbia-gr5069').mode('overwrite').save()

# COMMAND ----------

predDF_final_done = spark.read.format("jdbc").option("url", "jdbc:mysql://gr5069-main.ccqalx6jsr2n.us-east-1.rds.amazonaws.com/gr5069_main") \
    .option("driver", "com.mysql.jdbc.Driver").option("dbtable", "ne_gr5069_airbnb_rentals_predictions") \
    .option("user", "admin_teams").option("password", "columbia-gr5069").load()
